...
barvagt <- c("ML6","GL7","NY5","GL5","NY7","ML7","GL1","GL8","GL3")
tidspunkt <- c(2.5*60,2.5*60,3*60,3*60,2.5*60,2.5*60,2.5*60,2.5*60,3*60)
tidspunkt <- cumsum(tidspunkt)
vagt <- data.frame(tidspunkt=tidspunkt,barvagt=barvagt)
data$vagt <- 0

if (length(which(data$ki == "ML6" & data$min >= 120 & data$min < 270))>0){data[which(data$ki == "ML6" & data$min >= 120 & data$min < 270),]$vagt = "ML6"}
if (length(which(data$ki == "GL7" & data$min >= 270 & data$min < 420))>0){data[which(data$ki == "GL7" & data$min >= 270 & data$min < 420),]$vagt = "GL7"}

if (length(which(data$ki == "NY5" & data$min >= 900 & data$min < 1080))>0){data[which(data$ki == "NY5" & data$min >= 900 & data$min < 1080),]$vagt = "NY5"} # Forhalsbar
if (length(which(data$ki == "GL5" & data$min >= 1080 & data$min < 1260))>0){data[which(data$ki == "GL5" & data$min >= 1080 & data$min < 1260),]$vagt = "GL5"} # Forhalsbar
if (length(which(data$ki == "NY7" & data$min >= 1260 & data$min < 1410))>0){data[which(data$ki == "NY7" & data$min >= 1260 & data$min < 1410),]$vagt = "NY7"}

if (length(which(data$ki == "ML7" & data$min >= 1410 & data$min < 1560))>0){data[which(data$ki == "ML7" & data$min >= 1410 & data$min < 1560),]$vagt = "ML7"} # Forhalsbar
if (length(which(data$ki == "GL1" & data$min >= 1560 & data$min < 1710) )>0){data[which(data$ki == "GL1" & data$min >= 1560 & data$min < 1710),]$vagt = "GL1"}
if (length(which(data$ki == "GL8" & data$min >= 1710 & data$min < 1860) )>0){data[which(data$ki == "GL8" & data$min >= 1710 & data$min < 1860),]$vagt = "GL8"}

if (length(which(data$ki == "GL3" & data$min >= 2340 & data$min < 2520) )>0){data[which(data$ki == "GL3" & data$min >= 2340 & data$min < 2520),]$vagt = "GL3"}
...
if (print == 1){png(file = "display/plots/plot5-streger-paa-barvagt.png",res=reso)}       
